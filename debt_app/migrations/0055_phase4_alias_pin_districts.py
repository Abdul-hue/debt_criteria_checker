...
Data + logic live in debt_app/county_routing_seed.py (shared with the
...
districts (county_routing_seed.UNPINNED_NO_RULE) have no rule anywhere and are
intentionally left as "manual review required".
"""

from django.db import migrations

from debt_app.county_routing_seed import apply_alias_pins
...
def reverse(apps, schema_editor):
    ...
    from debt_app.county_routing_seed import ALIAS_PINS
    CountyCouncilRouting = apps.get_model("debt_app", "CountyCouncilRouting")
    n = 0
