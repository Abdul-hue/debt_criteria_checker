...
from debt_app.criteria_engine import _cross_check_property_from_credit_report
...
def _lloyds_mortgage_account(balance_pence=10_609_800):
    """
    Minimal credit report mortgage account dict as credit_report_extractor emits it.
