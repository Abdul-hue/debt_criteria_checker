...
from debt_app.integrations.credit_report import extract_public_information
from debt_app.engine.criteria import _check_creditor_individual
...
from debt_app.engine.criteria import (  # noqa: E402
...
class ApplyAliasPinsTests(TestCase):
    ...
    def test_pins_existing_row_without_duplicating(self):
        from debt_app.seeds.county_routing import apply_alias_pins, ALIAS_PINS
    ...
    def test_strict_raises_on_ambiguous_match(self):
        from debt_app.seeds.county_routing import _find_rule
...
from debt_app.engine.criteria import _tig_10  # noqa: E402
...
from debt_app.engine.criteria import _tig_21_5, _watch_22_7  # noqa: E402
...
from debt_app.engine.criteria import _tig_16  # noqa: E402
