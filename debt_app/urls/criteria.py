...
from debt_app.views.criteria import (
    AssessCaseView,
    AssessHistoryView,
...
from debt_app.views.evaluate import EvaluateCaseView
from debt_app.views.evaluation_history import EvaluationHistoryView
from debt_app.views.internal_sfs import (
...
from debt_app.views.departments import (
    DepartmentListView,
